...
![AI coding productivity research findings](https://github.com/user-attachments/assets/f7cec497-3ee2-47d1-8f91-a18210625e19){width=100% .lightbox fig-alt="Chart showing AI tools often lead to more rework and can be counterproductive for complex brownfield codebases"}
...
![AI tools performance across different project types](https://github.com/user-attachments/assets/06f03232-f9d9-4a92-a182-37056bf877a4){width=100% .lightbox fig-alt="Chart showing AI tools work better for greenfield projects than complex brownfield codebases"}
...
![Naive context management approach](https://github.com/user-attachments/assets/7361a203-9d95-42e2-ac16-1f38b04adb58){width=100% .lightbox fig-alt="Diagram showing naive approach of chatting with AI agent for hours then discarding prompts"}
...
![Restarting sessions when off-track](https://github.com/user-attachments/assets/1bbbc8ad-60da-4f8b-98c3-e6603b04a0ce){width=100% .lightbox fig-alt="Diagram showing approach of discarding sessions and starting fresh with better prompts"}
...
![Intentional compaction workflow](https://github.com/user-attachments/assets/64b940e5-89b1-4f6c-a79c-ec2810d9af77){width=100% .lightbox fig-alt="Diagram showing intentional compaction approach where context is distilled into structured artifacts"}
...
![Example of good compaction output](https://github.com/user-attachments/assets/a7d5946d-4e81-46e8-b314-d02dae1f00ee){width=100% .lightbox fig-alt="Structured summary showing end goal, approach, completed steps, and current failure point"}
...
![Image](https://github.com/user-attachments/assets/c1e920e8-5dc5-4dd2-b76d-853b85a92e6a){width=100% .lightbox}
...
![Image](https://github.com/user-attachments/assets/a6ea98a6-665b-48af-983b-a1cb2c45e44c){width=100% .lightbox}
...
<details><summary>(video not playing on mobile? expand for the static image version)</summary>
  ![Image](https://github.com/user-attachments/assets/c72e7dba-1476-4ee9-9cb0-0f97d428b82a){width=100% .lightbox}
</details>


The ideal subagent response probably looks similar to the ideal ad-hoc compaction from above

![Image](https://github.com/user-attachments/assets/a7d5946d-4e81-46e8-b314-d02dae1f00ee){width=100% .lightbox}

Getting a subagent to return this is not trivial:

![Image](https://github.com/user-attachments/assets/2bcd30f6-84fd-4911-ac15-63f75619e76d){width=100% .lightbox}
...
![Image](https://github.com/user-attachments/assets/01c7818a-9a0d-4ede-a23b-fb0c2e80f843){width=100% .lightbox}
...
![Image](https://github.com/user-attachments/assets/dab49f61-caae-4c15-b481-ee9b8f64995f){width=100% .lightbox}

So you want to **focus human effort and attention** on the HIGHEST LEVERAGE parts of the pipeline.

![Image](https://github.com/user-attachments/assets/cf981f70-5e61-4938-aa9a-7dcb88c9f8a4){width=100% .lightbox}
...
![Image](https://github.com/user-attachments/assets/77f4001b-175f-4da6-a6d4-e00b80489476){width=100% .lightbox}
